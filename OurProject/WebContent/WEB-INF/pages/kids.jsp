        ...
        <div style="background-color:gray;" class="jumbotron">
            <ul class="nav navbar-nav">
             <li class="top"><a class="items" href="men">MEN </a></li>
                ...
                <li class="top"><a class="items" href="about.html">ABOUT US</a><li>
              
                <li class="top"><a class="items" href="contact.html">CONTACT US</a><li>
			...
			<div class="col-lg-12">
				<div class="col-lg-3">
					...
					<ul class="nav nav-pills nav-stacked">
						<li><a href="/OurProject/kids/tshirt">T-Shirts</a></li>
						
						<li><a href="/OurProject/kids/shirt">Shirts</a></li>
						<li><a href="/OurProject/kids/jeans">Jeans</a></li>
					</u>
					<script >
				...
				<div class="col-lg-9">
					<div class="row">
						<c:forEach items="${kidsdata}" var="m">
