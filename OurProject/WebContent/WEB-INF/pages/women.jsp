			...
			<div class="col-md-12 col-md-12 col-md-12">
				...
				<div style="background-color: gray;" class="jumbotron">
					<ul class="nav navbar-nav">
						...
						<li><br>
						<li class="top"><a class="items" href="about.html">ABOUT
								US</a>
						<li>
						
						<li class="top"><a class="items" href="contact.html">CONTACT
								US</a>
						<li>
					</ul>
				</div>
			...
			<div class="col-lg-12">
				<div class="col-lg-3">
					...
					<ul class="nav nav-pills nav-stacked">
						<li><a href="/OurProject/women/tshirt">T-Shirts</a></li>
						<li><a href="/OurProject/women/shirt">Shirts</a></li>
						<li><a href="/OurProject/women/jeans">Jeans</a></li>
					</ul>
				</div>
				<div class="col-lg-9">
					<div class="row">
						<c:forEach items="${womendata}" var="w">
							<div class="col-xs-6 col-md-4">

								<a href="/OurProject/details/${w.id}" class="thumbnail"> <img src="${w.imageurl}"
									alt="150x150" style="width: 150px; height: 150px;">

								</a>
								<div class="caption">
									<h5>
										<a href="/OurProject/details/${w.id}">${w.name}</a>
									</h5>
								</div>
							</div>
						</c:forEach>
